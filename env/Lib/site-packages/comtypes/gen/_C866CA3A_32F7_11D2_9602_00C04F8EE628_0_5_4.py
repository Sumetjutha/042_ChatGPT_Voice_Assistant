...
__all__ = [
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPRFirstElement',
    'IEnumString', 'SPRST_INACTIVE', 'DISPID_SRGCommit',
    'SPSModifier', 'DISPID_SpeechRecoContext', 'SpeechVoiceEvents',
    'SPFM_NUM_MODES', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SpeechWaveFormatEx', 'SRAExport',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SpeechPhraseProperty',
    'DISPID_SBSSeek', 'SAFT48kHz16BitStereo', 'SpeechAudioFormatType',
    'ISpeechXMLRecoResult', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVP_8',
    'ISpPhoneticAlphabetConverter', 'SRTStandard', 'SpeechRunState',
    'SPWF_SRENGINE', 'SPBINARYGRAMMAR', 'SVEAudioLevel',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SpeechPhraseAlternates', 'SP_VISEME_8', 'SPCT_DICTATION',
    'SPCS_DISABLED', 'SVSFIsNotXML', 'DISPID_SVSInputSentenceLength',
    'ISpeechPhraseInfoBuilder', 'SITooFast', 'ISpeechVoice', 'SVP_9',
    'SPEVENTSOURCEINFO', 'DISPID_SPRuleId', 'SAFTGSM610_8kHzMono',
    'SpeechCategoryPhoneConverters', 'SPVISEMES', 'DISPID_SBSFormat',
    'DISPID_SLPsCount', 'DISPID_SABufferInfo', 'DISPID_SRRPhraseInfo',
    'DISPID_SRCERequestUI', 'DISPID_SpeechRecoResult',
    'DISPID_SRRGetXMLErrorInfo', 'SPBO_NONE',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SOTDataKey',
    'SPXMLRESULTOPTIONS', 'SPSHORTCUTTYPE', 'SGDSActiveUserDelimited',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVP_13',
    'DISPID_SpeechPhraseBuilder', 'ISpeechLexiconPronunciations',
    'SRSActiveAlways', 'ISpeechPhraseAlternates', 'SP_VISEME_2',
    'DISPID_SPEs_NewEnum', 'SBONone', 'DISPID_SRCEAudioLevel',
    'SpeechTokenIdUserLexicon', 'DISPID_SASState',
    'DISPID_SOTGetDescription', 'DISPID_SRSetPropertyNumber',
    'SAFT16kHz16BitStereo', 'SpeechPropertyResourceUsage',
    'SPAO_RETAIN_AUDIO', 'SPAO_NONE', '_RemotableHandle',
    'DISPID_SpeechPhraseElement', 'DISPID_SPEAudioTimeOffset',
    'SLOStatic', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPRText',
    'SP_VISEME_4', 'SREHypothesis',
    'SpeechGrammarRuleStateTransitionType', 'SPSLMA',
    'DISPID_SpeechPhraseInfo', 'DISPID_SRSAudioStatus',
    'SPPS_SuppressWord', 'SPRULE', 'ISpDataKey',
    'SpeechAddRemoveWord',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SDTReplacement', 'SRARoot', 'DISPID_SPERetainedSizeBytes',
    'SPAUDIOBUFFERINFO', 'SPAR_Unknown', 'DISPID_SVESentenceBoundary',
    'DISPID_SPEDisplayAttributes', 'DISPIDSPTSI_SelectionOffset',
    'SRATopLevel', 'SAFTADPCM_22kHzMono', 'DISPID_SOTCategory',
    'SAFT22kHz16BitStereo', 'SPBO_TIME_UNITS', 'SPPROPERTYINFO',
    'SAFTADPCM_44kHzMono', 'SAFTGSM610_11kHzMono',
    'DISPID_SPIReplacements', 'eLEXTYPE_VENDORLEXICON',
    'SPGS_EXCLUSIVE', 'SPEI_VOICE_CHANGE', 'DISPID_SCSBaseStream',
    'SPPHRASERULE', 'SPVPRI_OVER', 'DISPID_SRCState',
    'eLEXTYPE_RESERVED7', 'SPEI_PHONEME', 'DISPID_SGRsItem',
    'DISPID_SWFEBitsPerSample', 'SpeechCategoryAppLexicons',
    'SSSPTRelativeToStart', 'DISPID_SGRsFindRule', 'UINT_PTR',
    'ISpeechAudio', 'SVF_None', 'DISPID_SABIBufferSize',
    'DISPID_SRRDiscardResultInfo', 'SpAudioFormat',
    'SpeechGrammarState', 'DISPID_SVEBookmark', 'SAFTADPCM_11kHzMono',
    'ISpeechRecoResult', 'ISpeechPhoneConverter',
    'eLEXTYPE_PRIVATE15', 'DISPID_SPACommit', 'SRERecoOtherContext',
    'SAFT32kHz8BitStereo', 'DISPID_SVSInputWordLength',
    'ISpeechPhraseReplacement', 'SPEVENTENUM',
    'DISPID_SRCERecognition', 'SAFT8kHz16BitStereo',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SVGetVoices',
    'DISPID_SVEStreamEnd', 'DISPID_SPEAudioStreamOffset',
    'SDA_Two_Trailing_Spaces', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRDisplayUI', 'SAFT48kHz8BitMono', 'ISpSerializeState',
    'IInternetSecurityMgrSite', 'DISPID_SRGDictationSetState',
    'SAFT44kHz8BitStereo', 'SAFTNonStandardFormat',
    'SpSharedRecognizer', 'DISPID_SpeechRecognizer',
    'SPEI_RECO_OTHER_CONTEXT', 'SSFMCreateForWrite',
    'DISPID_SPAsItem', 'DISPID_SDKGetlongValue',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SpeechPhraseRule',
    'SPRST_NUM_STATES', 'DISPID_SPIEnginePrivateData', 'SP_VISEME_17',
    'DISPID_SPPConfidence', 'DISPID_SpeechAudioStatus',
    'DISPID_SRRRecoContext', 'SpShortcut', 'DISPID_SGRAttributes',
    'SpeechAudioState', 'SPEI_RESERVED1',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SRCEAdaptation',
    'DISPID_SVGetProfiles', 'SVP_12', 'DISPID_SPEsCount',
    'DISPID_SGRSTPropertyId',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SVSCurrentStreamNumber',
    'ISpNotifySource', 'SFTSREngine', 'SPBOOKMARKOPTIONS',
    'STSF_FlagCreate', 'DISPID_SPCIdToPhone', 'SPPS_LMA',
    'DISPID_SLGetPronunciations', 'SPPS_Unknown',
    'SDA_One_Trailing_Space', 'SDKLCurrentUser', 'SVP_14',
    'ISpPhrase', 'DISPID_SAFGuid', 'SRERequestUI', 'SpeechWordType',
    'SAFT48kHz16BitMono', 'DISPID_SRGetRecognizers',
    'ISpeechAudioBufferInfo', 'SAFT24kHz8BitStereo',
    'DISPID_SRGState', 'SAFTGSM610_44kHzMono', 'eLEXTYPE_RESERVED4',
    'SpTextSelectionInformation', 'SAFTCCITT_uLaw_11kHzStereo',
    'SAFT8kHz16BitMono', 'SREPrivate', 'DISPID_SRCreateRecoContext',
    'SPGRAMMARWORDTYPE', 'SPEI_VISEME', 'DISPID_SVSVisemeId',
    'ISpeechPhraseProperties', 'SpMMAudioOut', 'SVSFlagsAsync',
    'IStream', 'SP_VISEME_10', 'eLEXTYPE_RESERVED8', 'ISpLexicon',
    'DISPID_SPAPhraseInfo', 'ISpeechRecognizer', 'DISPID_SPIGetText',
    'ISpeechRecoResultTimes', 'SpeechAudioFormatGUIDText',
    'SVF_Emphasis', 'SAFTCCITT_uLaw_8kHzStereo', 'SPBO_AHEAD',
    'DISPID_SPIRule', 'SVP_7', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SLWPronunciations', 'SRTEmulated',
    'DISPID_SRSetPropertyString', 'SpStreamFormatConverter',
    'SPRST_ACTIVE', 'SAFT22kHz16BitMono', 'SPLO_DYNAMIC',
    'DISPID_SPRsCount', 'DISPID_SDKGetBinaryValue', 'SPWT_DISPLAY',
    'ISpPhoneConverter', 'SAFT32kHz16BitMono',
    'DISPID_SABufferNotifySize', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SVF_Stressed', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechRecoResultTimes', 'SECFIgnoreWidth',
    'SRSEIsSpeaking', 'DISPID_SRCEPhraseStart',
    'DISPID_SRCERecognitionForOtherContext', 'SPSERIALIZEDRESULT',
    'SRADefaultToActive', 'DISPID_SRCVoice',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SpeechXMLRecoResult',
    'SREStreamStart', 'SRAONone', 'eLEXTYPE_MORPHOLOGY',
    'eLEXTYPE_PRIVATE18', 'SECLowConfidence', 'DISPIDSPRG',
    'DISPID_SPPId', 'DISPID_SGRSTsItem', 'SpeechInterference',
    'SPINTERFERENCE', 'SGSExclusive', 'DISPID_SVResume',
    'DISPID_SLGetWords', 'SREPropertyNumChange', 'eLEXTYPE_PRIVATE6',
    'ISpeechObjectToken', 'SREPhraseStart', 'SAFT11kHz16BitStereo',
    'SRTAutopause', 'SAFT16kHz8BitMono', 'DISPID_SLAddPronunciation',
    'SAFTCCITT_ALaw_8kHzStereo', 'eLEXTYPE_PRIVATE11', 'SDTAudio',
    'DISPID_SVEVoiceChange', 'ISequentialStream',
    'IEnumSpObjectTokens', 'SAFT12kHz8BitMono', 'SASClosed',
    'SPPS_Noun', 'SpCompressedLexicon', 'SPRULESTATE',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SpeechLexiconWord',
    'SVP_3', 'SPAR_High', 'DISPID_SRRAudioFormat',
    'eWORDTYPE_DELETED', 'DISPID_SVAudioOutputStream',
    'DISPID_SGRSTText', 'SPPS_NotOverriden', 'DISPID_SGRs_NewEnum',
    'SRADynamic', 'SSSPTRelativeToEnd', 'SVEWordBoundary',
    'SPSHT_NotOverriden', 'SPWF_INPUT', 'DISPID_SPIAudioSizeTime',
    'DISPID_SLPPartOfSpeech', 'SpeechVoicePriority', 'SVP_16',
    'DISPID_SPRs_NewEnum', 'DISPID_SGRsAdd', 'DISPID_SGRSRule',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPPHRASEREPLACEMENT',
    'DISPID_SpeechPhoneConverter', 'SpResourceManager',
    'SP_VISEME_13', 'SAFT24kHz16BitMono', 'SVSFParseSsml',
    'SAFT24kHz16BitStereo', 'DISPID_SVSInputSentencePosition',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SDKDeleteValue',
    'SVPNormal', 'SP_VISEME_16', 'DISPID_SDKCreateKey',
    'DISPID_SAVolume', 'SPSFunction', 'SPEI_RECO_STATE_CHANGE',
    'SPCT_SUB_COMMAND', 'DISPID_SVSyncronousSpeakTimeout',
    'SPSUnknown', 'SECFIgnoreKanaType', 'SPDATAKEYLOCATION',
    'ISpeechPhraseRules', 'DISPID_SpeechGrammarRules', 'SGSEnabled',
    'SpeechTokenContext', 'DISPID_SPCLangId', 'SRSInactive',
    'DISPID_SREmulateRecognition', 'DISPID_SVEventInterests',
    'DISPID_SRState', 'SITooLoud', 'DISPID_SGRSTWeight',
    'SP_VISEME_9', 'DISPID_SpeechAudioBufferInfo', 'SGRSTTWildcard',
    'ISpResourceManager', 'SAFTText', 'SAFTADPCM_22kHzStereo',
    'DISPID_SGRSTType', 'Speech_Max_Pron_Length', 'SVSFParseMask',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SMSGetData',
    'DISPID_SVEViseme', 'SpSharedRecoContext',
    'DISPID_SRGetPropertyString', 'SP_VISEME_6', 'SpeechRuleState',
    '_ISpeechRecoContextEvents', 'DISPID_SRAudioInputStream',
    'DISPID_SDKEnumValues', 'DISPID_SpeechLexiconWords',
    'SpeechTokenKeyFiles', 'DISPID_SWFEExtraData',
    'DISPID_SOTCreateInstance', 'ISpNotifySink', 'SWTAdded',
    'SPVPRI_ALERT', 'SpeechPartOfSpeech', 'DISPID_SPEDisplayText',
    'SPPS_RESERVED4', 'DISPID_SBSRead', 'SPAS_CLOSED',
    'DISPID_SGRInitialState', 'DISPID_SRRTStreamTime',
    'DISPID_SRGCmdLoadFromFile', 'SPFILEMODE', 'SpWaveFormatEx',
    'DISPID_SPILanguageId', 'SpVoice', 'eLEXTYPE_PRIVATE5',
    'SPGS_DISABLED', 'SPLEXICONTYPE',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRCRequestedUIType', 'STCInprocHandler', 'SPAUDIOSTATUS',
    'SECFIgnoreCase', 'DISPID_SVSRunningState', 'SVSFIsXML',
    'ISpeechPhraseReplacements', 'SAFTNoAssignedFormat',
    'ISpeechLexiconWord', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRCBookmark', 'SPEI_MIN_TTS', 'DISPID_SLPs_NewEnum',
    'SpeechWordPronounceable', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPEI_RECOGNITION', 'DISPID_SPRulesCount', 'SPRST_ACTIVE_ALWAYS',
    'SpeechPropertyComplexResponseSpeed', 'SGRSTTRule', 'SPFM_CREATE',
    'SINoise', 'SpeechTokenKeyAttributes', 'SECFDefault',
    'SAFTADPCM_44kHzStereo', 'SPRECOCONTEXTSTATUS',
    'SpeechUserTraining', 'DISPID_SLPPhoneIds',
    'DISPID_SASCurrentSeekPosition', 'SAFT8kHz8BitMono',
    'DISPID_SRSClsidEngine', 'DISPID_SRCSetAdaptationData',
    'SPSHT_Unknown', 'DISPID_SPEAudioSizeTime',
    'DISPID_SLRemovePronunciation', 'DISPIDSPTSI_SelectionLength',
    'SDTProperty', 'ISpStream', 'eLEXTYPE_PRIVATE2',
    'SVSFUnusedFlags', 'SLTUser', 'SPDKL_CurrentUser',
    'SpeechDictationTopicSpelling', 'SRAImport',
    'SpeechCategoryRecoProfiles', 'SPEI_TTS_PRIVATE', 'SPAS_PAUSE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SRGId',
    'DISPID_SRGCmdLoadFromMemory', 'SAFT32kHz16BitStereo',
    'SpeechVoiceSkipTypeSentence', 'SpeechLexiconType',
    'DISPID_SLPType', 'SpPhoneConverter', 'SPEI_REQUEST_UI',
    'DISPID_SVSPhonemeId', 'SVP_21', 'SPRST_INACTIVE_WITH_PURGE',
    'SAFT32kHz8BitMono', 'DISPID_SPEAudioSizeBytes',
    'SAFT11kHz16BitMono', 'SPEI_TTS_BOOKMARK', 'eLEXTYPE_PRIVATE16',
    'ISpeechMemoryStream', 'SPEI_RESERVED6',
    'DISPID_SPPEngineConfidence', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SRGSetTextSelection', 'DISPID_SpeechPhraseAlternate',
    'ISpProperties', 'DISPID_SGRSTPropertyName', 'SVP_2',
    'DISPID_SMSSetData', 'SVPOver', 'SpeechDataKeyLocation',
    'ISpeechFileStream', 'SPEI_WORD_BOUNDARY', 'SPEI_ADAPTATION',
    'SPWORD', 'SpPhraseInfoBuilder', 'SpeechRecoContextState',
    'SPPHRASE', 'SPEI_MIN_SR', 'STSF_CommonAppData',
    'ISpRecoGrammar2', 'SBOPause', 'DISPID_SPIStartTime', 'SVP_17',
    'SREAdaptation', 'SREInterference', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SPAsCount', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SpeechGrammarRule', 'SRTReSent',
    'SpPhoneticAlphabetConverter', 'DISPID_SOTIsUISupported',
    'SECHighConfidence', 'DISPID_SOTs_NewEnum', 'SpeechDiscardType',
    'SPPARTOFSPEECH', 'SP_VISEME_14', 'DISPID_SGRClear',
    'SP_VISEME_18', 'SAFTCCITT_uLaw_44kHzMono', 'SPCT_SUB_DICTATION',
    'SVP_11', 'DISPID_SRCResume', 'eLEXTYPE_PRIVATE12',
    'SPINTERFERENCE_NOSIGNAL', '__MIDL_IWinTypes_0009',
    'DISPID_SOTsCount', 'SVP_19', 'SpeechCategoryVoices',
    'DISPID_SVSLastResult', 'DISPID_SLWType', 'SpStream',
    'DISPID_SPRuleParent', 'DISPID_SOTSetId', 'DISPID_SOTsItem',
    'DISPID_SVPause', 'SPXRO_SML', 'SGDSActive', 'eLEXTYPE_PRIVATE9',
    'SpeechLoadOption', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechRecoProfileProperties', 'ISpeechBaseStream',
    'eLEXTYPE_USER_SHORTCUT', 'ISpeechDataKey', 'ISpeechGrammarRules',
    'DISPID_SRCEStartStream', 'SAFTCCITT_ALaw_11kHzMono',
    'SRTSMLTimeout', 'SPFM_OPEN_READWRITE', 'SpMMAudioIn',
    'DISPID_SRRTimes', 'ISpPhoneticAlphabetSelection',
    'ISpEventSource', 'SpeechBookmarkOptions',
    'ISpObjectTokenCategory', 'DISPID_SRCCreateResultFromMemory',
    'ISpRecognizer3', 'SPEI_SR_BOOKMARK', 'SITooSlow',
    'ISpStreamFormatConverter', 'ISpAudio', 'tagSPPROPERTYINFO',
    'DISPID_SPAs_NewEnum', 'SPEI_START_INPUT_STREAM',
    'SPEI_START_SR_STREAM', 'DISPID_SDKOpenKey',
    'DISPID_SGRSAddRuleTransition', 'ISpeechObjectTokenCategory',
    'DISPID_SVGetAudioOutputs', 'DISPID_SRCEEndStream',
    'SVEStartInputStream', 'DISPID_SRCCreateGrammar', 'SPEVENT',
    'ISpeechLexiconWords', 'SPPS_RESERVED1', 'ISpShortcut',
    'DISPID_SADefaultFormat', 'DISPID_SRRTTickCount',
    'SRAInterpreter', 'DISPID_SPRules_NewEnum', 'SPRECOGNIZERSTATUS',
    'SVP_20', 'ISpeechPhraseElement', 'DISPID_SRRecognizer',
    'DISPID_SPCPhoneToId', 'DISPID_SpeechPhraseProperties', 'SDTAll',
    'DISPID_SLPSymbolic', 'DISPID_SPPsCount', 'DISPID_SGRSTNextState',
    'ISpeechWaveFormatEx', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SPRDisplayAttributes', 'ISpeechVoiceStatus', 'SVP_6',
    'ISpVoice', 'DISPID_SRRGetXMLResult',
    'SpeechRetainedAudioOptions', 'DISPID_SVAlertBoundary',
    'DISPID_SOTRemove', 'DISPID_SPPsItem', 'ISpRecoContext',
    'eLEXTYPE_USER', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SRCESoundEnd', 'SPSEMANTICERRORINFO',
    'ISpeechGrammarRuleState', 'SPXRO_Alternates_SML',
    'SDA_No_Trailing_Space', 'DISPID_SAStatus',
    'DISPID_SpeechMMSysAudio', 'SpNullPhoneConverter',
    'SpeechCategoryAudioOut', 'ISpNotifyTranslator',
    'STSF_LocalAppData', 'DISPID_SGRAddResource',
    'DISPID_SVSLastBookmarkId', 'DISPID_SGRSTsCount',
    'DISPID_SVEWord', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRCEFalseRecognition', 'SVP_10',
    'SPEI_PROPERTY_NUM_CHANGE', 'SWTDeleted',
    'DISPID_SOTGetStorageFileName', 'DISPID_SRSSupportedLanguages',
    'SLODynamic', 'SWPUnknownWordPronounceable',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SFSOpen',
    'SGRSTTEpsilon', 'DISPID_SOTMatchesAttributes',
    'ISpeechCustomStream', 'DISPID_SpeechRecoResult2',
    'SSTTDictation', 'SGDSInactive', 'SpeechRecoEvents',
    'SREStateChange', 'SPCT_SLEEP', 'SpeechGrammarWordType',
    'SPWORDPRONUNCIATION', 'SREStreamEnd', 'DISPID_SVVoice',
    'DISPID_SVIsUISupported', 'SPEI_RESERVED3',
    'DISPID_SpeechPhraseReplacement', 'SP_VISEME_3',
    'ISpeechPhraseRule', 'DISPID_SRGRecoContext', 'SpLexicon',
    'SASPause', 'eLEXTYPE_APP', 'DISPID_SFSClose', 'DISPID_SBSWrite',
    'eLEXTYPE_PRIVATE14', 'DISPID_SMSALineId', 'DISPID_SVPriority',
    'SVP_15', 'DISPID_SRGSetWordSequenceData',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SMSAMMHandle',
    'eLEXTYPE_PRIVATE20', 'DISPID_SPELexicalForm', 'SPSEMANTICFORMAT',
    'SPPHRASEPROPERTY', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SPRuleNumberOfElements', 'SPPHRASEELEMENT',
    'DISPID_SPEEngineConfidence', 'SpeechEngineConfidence',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPIRetainedSizeBytes',
    'ISpeechPhraseProperty', 'SPTEXTSELECTIONINFO', 'SRSActive',
    'DISPID_SPRuleChildren', 'SPINTERFERENCE_NOISE',
    'Speech_StreamPos_RealTime', 'SVEEndInputStream',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpRecognizer2',
    'SPEI_SOUND_START', 'Speech_StreamPos_Asap', 'SPEI_UNDEFINED',
    'DISPID_SDKSetStringValue', 'ISpStreamFormat',
    'SPADAPTATIONRELEVANCE', 'SPCT_COMMAND', 'SDKLDefaultLocation',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechPropertyAdaptationOn',
    'DISPID_SRRSaveToMemory', 'SSTTTextBuffer', 'DISPID_SLWWord',
    'DISPID_SRCEventInterests', 'SpInprocRecognizer',
    'DISPID_SLPLangId', 'DISPID_SVEEnginePrivate', 'SITooQuiet',
    'SPEI_PHRASE_START', 'SpeechEmulationCompareFlags',
    'DISPID_SPIGrammarId', 'SAFTDefault', 'SpeechRecognizerState',
    'STCLocalServer', 'SpeechAudioVolume', 'DISPID_SDKDeleteKey',
    'ISpeechPhraseElements', 'SAFT12kHz16BitMono', 'SGLexical',
    'DISPID_SOTCDefault', 'SAFT44kHz16BitStereo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SRAudioInput',
    'Speech_Default_Weight', 'SREAudioLevel', 'tagSTATSTG',
    'SpeechPropertyResponseSpeed', 'SAFTADPCM_8kHzStereo',
    'SpeechGrammarTagDictation', 'ISpeechTextSelectionInformation',
    'SP_VISEME_5', 'WAVEFORMATEX', 'SpMMAudioEnum', 'SPPS_Verb',
    'DISPID_SRGCmdSetRuleIdState', 'SPLO_STATIC',
    'DISPID_SWFEBlockAlign', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SPPBRestorePhraseFromMemory', 'SpeechAudioProperties',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SMSADeviceId',
    'DISPID_SRRAudio', 'SRCS_Enabled', 'SPPS_Noncontent',
    'SPFM_CREATE_ALWAYS', 'SAFTCCITT_uLaw_11kHzMono',
    'SAFTCCITT_ALaw_44kHzMono', 'SDTPronunciation',
    'SAFTADPCM_11kHzStereo', 'SpeechRecognitionType', 'SP_VISEME_1',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPARecoResult',
    'DISPID_SOTDisplayUI', 'SVP_18', 'DISPID_SPAStartElementInResult',
    'SAFT44kHz8BitMono', 'SAFTCCITT_ALaw_8kHzMono', 'SFTInput',
    'DISPID_SRSCurrentStreamNumber', 'SP_VISEME_19', 'SPSMF_UPS',
    'DISPID_SpeechObjectTokens', 'ISpMMSysAudio', 'ISpeechLexicon',
    'DISPID_SpeechAudio', 'DISPID_SRIsUISupported',
    'ISpeechPhraseAlternate', 'SDTAlternates',
    'SWPKnownWordPronounceable', 'SPEI_HYPOTHESIS', 'DISPID_SPPName',
    'DISPID_SVAudioOutput', 'DISPID_SOTCEnumerateTokens',
    'SAFTCCITT_uLaw_44kHzStereo', 'STCRemoteServer',
    'DISPID_SRGDictationLoad', 'DISPID_SRSCurrentStreamPosition',
    'SPAUDIOSTATE', 'SPEI_RESERVED5', 'eLEXTYPE_LETTERTOSOUND',
    'ISpeechPhraseInfo', 'DISPID_SAFSetWaveFormatEx',
    'SpeechGrammarTagWildcard', 'SRAORetainAudio',
    'SPEI_FALSE_RECOGNITION', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPRNumberOfElements', 'SPSHORTCUTPAIR',
    'DISPID_SWFEChannels', 'DISPID_SpeechLexiconProns',
    'SPVPRI_NORMAL', 'SPCONTEXTSTATE', 'DISPID_SpeechAudioFormat',
    'ISpeechObjectTokens', 'DISPID_SpeechPhraseReplacements',
    'SVSFPurgeBeforeSpeak', 'DISPID_SAEventHandle', 'SPCATEGORYTYPE',
    'DISPID_SPIProperties', 'SVP_5', 'SVP_4', 'SpObjectToken',
    'SINoSignal', 'DISPID_SRProfile', 'SGDSActiveWithAutoPause',
    'SDKLLocalMachine', 'DISPID_SpeechFileStream',
    'SPINTERFERENCE_TOOLOUD', 'SpeechTokenKeyUI',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SASNonBlockingIO',
    'DISPID_SPPs_NewEnum', 'DISPID_SpeechPhraseRules',
    'SAFT24kHz8BitMono', 'DISPID_SpeechVoice', 'DISPID_SpeechLexicon',
    '_SPAUDIOSTATE', 'DISPID_SASetState', 'DISPID_SWFEFormatTag',
    'DISPID_SPEsItem', 'DISPID_SRGRules', 'SPPS_Interjection',
    'eWORDTYPE_ADDED', 'ISpeechAudioFormat', 'DISPID_SRGReset',
    'DISPID_SRCEHypothesis', 'SPSERIALIZEDPHRASE',
    'SPEI_END_INPUT_STREAM', 'SPRECOSTATE', 'SECFEmulateResult',
    'SSFMOpenForRead', 'SpeechDisplayAttributes',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SVSLastBookmark',
    'DISPID_SVEPhoneme', 'SAFT12kHz16BitStereo', 'SP_VISEME_11',
    'DISPID_SVSkip', 'SpNotifyTranslator', 'SPGS_ENABLED',
    'SpFileStream', 'SGPronounciation', 'SRCS_Disabled',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVSFVoiceMask', 'SPAR_Medium',
    'SVEVoiceChange', 'DISPID_SRCERecognizerStateChange',
    'SPEI_SENTENCE_BOUNDARY', 'ISpObjectToken', 'ISpPhraseAlt',
    'DISPID_SGRsCommitAndSave', 'SVSFDefault', 'SPWT_PRONUNCIATION',
    'SPAUDIOOPTIONS', 'SDTLexicalForm', 'Speech_Max_Word_Length',
    'SpeechCategoryAudioIn', 'DISPID_SRGIsPronounceable',
    'SPEI_MAX_SR', 'DISPID_SOTId', 'SVEViseme',
    'DISPID_SLGenerationId', 'ISpeechGrammarRule',
    'SAFTExtendedAudioFormat', 'SpCustomStream', 'DISPID_SLPsItem',
    'SpeechTokenValueCLSID', 'DISPID_SWFEAvgBytesPerSec',
    'SpeechVisemeFeature', 'ISpeechLexiconPronunciation',
    'eLEXTYPE_PRIVATE3', 'SpeechStreamFileMode',
    'DISPID_SOTGetAttribute', 'SPWORDTYPE', 'SPRS_ACTIVE',
    'ISpeechRecoGrammar', 'DISPID_SVSLastStreamNumberQueued',
    'SPPS_RESERVED2', 'DISPID_SDKEnumKeys', 'DISPID_SABIEventBias',
    'DISPID_SOTCId', 'SPEI_SOUND_END', 'DISPID_SRGetPropertyNumber',
    'DISPID_SDKSetBinaryValue', 'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SGRId',
    'SAFT12kHz8BitStereo', 'DISPID_SGRSTransitions',
    'DISPID_SDKGetStringValue', 'eLEXTYPE_PRIVATE1', 'DISPID_SVSpeak',
    'SVP_0', 'DISPID_SPRuleConfidence', 'SP_VISEME_21',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPPFirstElement', 'SVSFNLPMask',
    'DISPID_SVRate', 'SPWAVEFORMATTYPE', '_ISpeechVoiceEvents',
    'SDTRule', 'ISpeechAudioStatus', 'SpeechRegistryUserRoot',
    'SpeechEngineProperties', 'SPSSuppressWord', 'SPVOICESTATUS',
    'SPSVerb', 'SPSInterjection', 'SGLexicalNoSpecialChars',
    'DISPID_SLGetGenerationChange', 'SPBO_PAUSE',
    'DISPID_SASFreeBufferSpace', 'ISpEventSink',
    'SAFT22kHz8BitStereo', 'SpeechStreamSeekPositionType',
    'SPSTREAMFORMATTYPE', 'SpeechMicTraining', 'SVSFParseSapi',
    'SGDisplay', 'SPPS_Function', 'ISpRecoContext2',
    'DISPID_SRRTLength', 'SPEI_RESERVED2',
    'DISPID_SRRTOffsetFromStart', 'SVP_1', 'SVEPhoneme',
    'SREPropertyStringChange', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SPPParent', 'SPDKL_DefaultLocation', 'LONG_PTR',
    'SP_VISEME_20', 'SPGRAMMARSTATE', 'DISPID_SpeechDataKey',
    'SAFT8kHz8BitStereo', 'SPSHT_OTHER', 'ISpeechMMSysAudio',
    'ISpRecoCategory', 'DISPID_SpeechObjectToken',
    'SPINTERFERENCE_TOOFAST', 'SRTExtendableParse', 'SASRun',
    'DISPID_SpeechGrammarRuleState', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SVWaitUntilDone', 'SAFTGSM610_22kHzMono',
    'eLEXTYPE_RESERVED10', 'SPSHORTCUTPAIRLIST', 'SVSFPersistXML',
    'ISpXMLRecoResult', 'DISPID_SPIGetDisplayAttributes',
    'eLEXTYPE_RESERVED6', 'eLEXTYPE_PRIVATE7', 'SPAR_Low',
    'SAFT11kHz8BitMono', 'DISPID_SGRSTPropertyValue',
    'DISPID_SpeechObjectTokenCategory', 'STCAll',
    'SpInProcRecoContext', 'DISPID_SGRsDynamic',
    'DISPID_SPEPronunciation', 'DISPID_SRCPause', 'DISPID_SGRsCount',
    'SPSNotOverriden', 'DISPID_SPERequiredConfidence',
    'SPINTERFERENCE_NONE', 'SAFT48kHz8BitStereo',
    'DISPID_SRCESoundStart', 'SAFTADPCM_8kHzMono', 'SPCS_ENABLED',
    'DISPID_SpeechBaseStream', 'DISPID_SPPChildren',
    'SVESentenceBoundary', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRCCmdMaxAlternates', 'SREFalseRecognition',
    'SPSMF_SAPI_PROPERTIES', 'eLEXTYPE_PRIVATE19', 'SPVPRIORITY',
    'SSTTWildcard', 'ISpeechRecoResult2', 'SECFNoSpecialChars',
    'SpMemoryStream', 'DISPID_SPERetainedStreamOffset', 'SGRSTTWord',
    'DISPID_SRCEPropertyNumberChange', 'SpeechTokenShellFolder',
    'DISPID_SVSpeakStream', 'DISPID_SRCRetainedAudio',
    'SDA_Consume_Leading_Spaces', 'SPEI_MAX_TTS',
    'DISPID_SpeechPhraseElements', 'STCInprocServer',
    'eLEXTYPE_PRIVATE17', 'SRERecognition', 'DISPID_SPISaveToMemory',
    'ISpRecoResult', 'DISPID_SRGDictationUnload', 'SVSFNLPSpeakPunc',
    'eLEXTYPE_PRIVATE4', 'SPWORDPRONOUNCEABLE', 'DISPID_SGRName',
    'SPSNoun', 'ISpGrammarBuilder', 'SPEI_INTERFERENCE',
    'SPEI_SR_PRIVATE', 'DISPID_SpeechCustomStream',
    'tagSPTEXTSELECTIONINFO', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SAFType', 'SPEI_SR_RETAINEDAUDIO',
    'SWPUnknownWordUnpronounceable', 'SDKLCurrentConfig',
    'DISPID_SOTCGetDataKey', 'SpeechAllElements',
    'DISPID_SRCEBookmark', 'SVEPrivate', 'DISPID_SGRSTs_NewEnum',
    'SPFM_OPEN_READONLY', 'SPWORDLIST', 'ISpeechRecognizerStatus',
    'ISpRecoGrammar', 'SpObjectTokenCategory',
    'SpeechGrammarTagUnlimitedDictation', 'ISpeechRecoResultDispatch',
    'SpeechAudioFormatGUIDWave', 'SRSInactiveWithPurge',
    'SP_VISEME_7', 'DISPID_SPEActualConfidence', 'DISPID_SPPValue',
    'DISPID_SLWsCount', 'DISPID_SRCEInterference',
    'DISPID_SRRAlternates', 'ISpRecognizer', 'DISPID_SVEStreamStart',
    'SpeechVoiceSpeakFlags', 'DISPID_SPRuleName',
    'DISPID_SGRAddState', 'SPDKL_CurrentConfig', 'SPEI_END_SR_STREAM',
    'DISPID_SASCurrentDevicePosition', 'SpeechRuleAttributes',
    'SSFMCreate', 'DISPID_SpeechMemoryStream', 'eLEXTYPE_RESERVED9',
    'SPWT_LEXICAL', 'SAFT22kHz8BitMono', 'SGRSTTTextBuffer',
    'SpeechSpecialTransitionType', 'DISPID_SDKSetLongValue',
    'DISPID_SRGetFormat', 'DISPIDSPTSI', 'ISpeechRecoContext',
    'SSFMOpenReadWrite', 'DISPID_SRIsShared', 'SVSFParseAutodetect',
    'SVEBookmark', 'SVEAllEvents', 'DISPID_SRCEEnginePrivate',
    'DISPID_SLWsItem', 'DISPID_SRRSetTextFeedback',
    'SpUnCompressedLexicon',
    'DISPID_SpeechGrammarRuleStateTransition', 'SLTApp',
    'DISPID_SPIAudioSizeBytes', 'SAFT44kHz16BitMono',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRCRecognizer',
    'SpeechVisemeType', 'SPAS_RUN', 'SPPS_Modifier',
    'DISPID_SPPNumberOfElements', 'SASStop', 'eLEXTYPE_PRIVATE8',
    'SGRSTTDictation', 'DISPID_SPRsItem', 'SPRECORESULTTIMES',
    'eLEXTYPE_PRIVATE13', 'DISPID_SVStatus',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPPS_RESERVED3', 'SINone',
    'SAFT16kHz16BitMono', 'SpeechCategoryRecognizers',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPRuleFirstElement',
    'STSF_AppData', 'DISPID_SLWs_NewEnum', 'SPLOADOPTIONS',
    'SREBookmark', 'DISPID_SVVolume', 'SPRS_INACTIVE',
    'DISPID_SRStatus', 'SGSDisabled', 'ISpObjectWithToken',
    'SECNormalConfidence', 'DISPID_SRRSpeakAudio', 'SRESoundStart',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SVSFIsFilename',
    'SP_VISEME_0', 'DISPID_SpeechRecoContextEvents',
    'SpeechPropertyHighConfidenceThreshold', 'ISpeechResourceLoader',
    'SDTDisplayText', 'SP_VISEME_12', 'SAFT16kHz8BitStereo',
    'SVPAlert', 'eLEXTYPE_PRIVATE10', 'DISPID_SGRSAddWordTransition',
    'SPAS_STOP', 'SP_VISEME_15', 'SRESoundEnd', 'SAFT11kHz8BitStereo',
    'DISPID_SABIMinNotification', 'DISPID_SLWLangId',
    'SpeechFormatType', 'DISPID_SPRulesItem', 'SPSHT_EMAIL',
    'DISPID_SGRsCommit', 'DISPID_SVGetAudioInputs',
    'DISPID_SVEAudioLevel', 'DISPID_SPIEngineId', 'SREAllEvents',
    'DISPID_SGRSTRule', 'DISPID_SPIElements', 'SPDKL_LocalMachine',
    'DISPID_SVSInputWordPosition', 'DISPID_SOTCSetId',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SRSEDone', 'DISPID_SVDisplayUI',
    'DISPID_SOTRemoveStorageFileName', 'IInternetSecurityManager',
